 ...
 *      2. multiply them one by one, using inline function
 *      3. measure the time taken
 * 
 * Compile: clang++ TMA3Question2.cpp -o TMA3Question2
...
void func()
{
	...
	for (int i = 0; i < 10000; i++)
	{
		std::clog << inline_multiply(double_array_1[i], double_array_2[i])
...
int main(int argc, char const * argv[])
{
	...
	std::cout << "Q2 Elapsed Time: " << elapsed_time << "s" << std::endl;
